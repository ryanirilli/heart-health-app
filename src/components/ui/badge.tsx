  ...
  "inline-flex items-center border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        goalProgress: "rounded-full border-transparent bg-primary/8 text-foreground/80",
        goalProgressOutline: "rounded-full border-transparent bg-primary/8 text-foreground/80",

...
export function createDefaultActivityType(partial: Partial<ActivityType> = {}): ActivityType {
  return {
...
export function getButtonOptionLabel(type: ActivityType, value: number): string | undefined {
